...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *AWSLambdaLab*):
...
Execute unit tests
```
    cd "AWSLambdaLab/test/AWSLambdaLab.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSLambdaLab/src/AWSLambdaLab"
